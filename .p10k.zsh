# Generated by Powerlevel10k configuration wizard on 2021-04-10 at 23:02 HST.
...
######### ADDED BY ME ##########
# Can edit these to change directory icons:
# typeset -g POWERLEVEL9K_HOME_ICON='$' <-- either paste an emoji or add $'\u####'
